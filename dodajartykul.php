...
<body>
	...
	<div id="tresc">
		...
		<div id="pading" style="padding-left:15%;color:red;">
		<form action="dodajartykul.php" method="post"	onsubmit="confirm(na pewno sprawdziłeś i chcesz wysłać Formularz?)">
								<label for="imie">Nazwa Artykułu:</label><br>
								<input maxlength="40" type="text"	rows="50" name="imie" id="imie" required></input>
								<br><br>
								<label for="opis">Treść artykułu</label><br>
								<textarea name="opis" id="opis" rows="50" cols="100"></textarea>
								<br><br>
